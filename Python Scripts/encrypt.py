...
# Select file
fileName = input("Name of PDF file: ")
# Open our PDF file with the PdfFileReader
file = PdfFileReader(fr"C:\Users\Gustav Ahlström\Downloads\{fileName}.pdf")
...
with open(rf"C:\Users\Gustav Ahlström\Downloads\{fileName}_encrypted.pdf", "wb") as f:
